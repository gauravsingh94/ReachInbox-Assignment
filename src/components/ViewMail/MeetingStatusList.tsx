...
const MeetingStatusList = () => {
  return (
    <div className="h-8 w-[180px] py-[6px] px-[8px] rounded-sm border-[1px] border-borderColorLight dark:border-borderColorDark bg-white dark:bg-[#1F1F1F] text-[12px] flex items-center justify-between ]">
      <div>
        <div
      ...
      <div className="flex items-center justify-center gap-2">
        <div>
          <h1 className="text-black dark:text-white">Meeting Completed</h1>
        </div>
